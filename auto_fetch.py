...
def fetch_new_p2e(limit=5):
    """
    Парсим playtoearn.net и возвращаем список новых P2E игр.
    limit — количество игр для вывода.
    """
    ...
    items = soup.select(".game-item")[:limit]
    results = []
    ...
    for it in items:
        ...
        results.append({"name": name, "genre": genre, "link": link})
